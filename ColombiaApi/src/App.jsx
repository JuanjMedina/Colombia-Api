...
import data from './data/Presidents.json'
function App() {
  return (
    <main
      className="min-h-screen h-full w-screen flex flex-col items-center text-white overflow-x-hidden
    ...
    >
      ...
      <div className="w-[45%]  text-black flex flex-col gap-8">
        <SearchInputs />
        <HasData data={data} />
      </div>
    </main>
